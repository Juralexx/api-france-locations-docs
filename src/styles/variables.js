...
const variables = css`
    :root {
        --primary       : #25C19F;
        --primary-rgb   : 61, 207, 112;
        --primary-light : #3ee58c;
        --primary-dark  : #4c73f1;

        --body           : #242526;
        --body-rgb       : 36, 37, 38;
        --body-light     : #1b1b1d;
        --body-light-rgb : 27, 27, 29;
        
        --content       : #0d1117;
        --content-light : #161b22;
        --light-border  : #30363d;
        ...
        --font-fam-list : system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif,BlinkMacSystemFont,"Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol";
